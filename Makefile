...
ifneq ($(OS),Windows_NT)
    ...
    ATMEL_DEVICES='c:\Atmel\Studio\7.0\packs\atmel\ATmega_DFP\1.0.90\avrasm\inc\'
    AS_INCLUDE=-I $(ATMEL_DEVICES) -I$(CORE)  -I$(CORE)/devices/ -I$(AMFORTH)/common
endif
...
%.bak:
	@echo "Backup Flash & EEPROM from Arduino $*" 
...
TARGET = leonardo.hex uno.hex duemilanove.hex duemilanove168.hex mega128.hex sanguino.hex diecimila.hex
